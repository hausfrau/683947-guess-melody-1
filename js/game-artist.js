...
import gameGenre, {clearActions} from './game-genre';
...
const gameArtistScreen = renderScreen(template);

Array.from(gameArtistScreen.querySelectorAll(`.game__artist .artist__input`)).forEach((it) => it.addEventListener(`click`, () => changeScreen(gameGenre)));

const gameLogo = gameArtistScreen.querySelector(`.game__logo`);
